...
CORPUS_PATH = os.path.join('data','amazon_reviews')
...
with open("data\doc-topics-amazon-reviews.txt") as f:
	f.readline()
	for line in f:
...
CORPUS_PATH_UNSPLIT = os.path.join('data','amazon_reviews')
...
with open(r'data\topic-keys-amazon-reviews.txt') as input:
